...
<template>
  ...
  <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 l lg:gap-x-12">
          ...
          <div class="space-y-5 lg:space-y-8">
            ...
            <div class="grid lg:flex lg:justify-between lg:items-center gap-y-5 lg:gap-y-0">
              ...
              <div class="flex justify-end items-center gap-x-1.5">
                ...
                <!--    <div
                  class="block h-3 border-r border-gray-300 mx-1.5 dark:border-gray-600"
                ></div> -->
                ...
                <!--    <div class="hs-dropdown relative inline-flex">
                  ...
                  >
                    ...
                    <div
                      class="border-t border-gray-200 my-2 dark:border-gray-700"
                    ></div>
                    <a
                      class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                      href="#"
      ...
      <!-- Sidebar -->
      <div class="lg:col-span-1 lg:w-full lg:h-full border-l border-primary1/50">
        <div class="sticky top-0 left-0 py-8 lg:px-8">
          <!-- Avatar Media -->
          <!--  <div
