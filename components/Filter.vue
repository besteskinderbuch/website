...
<template>
      ...
      <div>
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900">Auswahl</h1>
  ...
  const sortOptions = [
    ...
    { name: 'Neuestes', href: '#', current: false },
  ]
  const filters = [
    {
      id: 'age',
      name: 'Alter',
      options: [
        { value: '0-1', label: '0-1', checked: false },
        ...
        { value: '8-11', label: '8-11', checked: false },
      ],
    },
    {
      id: 'category',
      name: 'Kategorie',
      options: [
        { value: 'dragons', label: 'Drachen', checked: false },
        { value: 'magic', label: 'Magie', checked: false },
        { value: 'nature', label: 'Natur', checked: false },
        { value: 'dogs', label: 'Hunde', checked: false },
      ],
    },
    {
      id: 'values',
      name: 'Werte',
      options: [
        { value: 'courage', label: 'Mut', checked: false },
        { value: 'friendschip', label: 'Freundschaft', checked: false },
      ],
    },
  ]
